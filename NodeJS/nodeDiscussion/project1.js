// Create a project to scan the files in the downloads folder and categorize them as compressed (for rar, zip, 7zip) files, documents (txt, xlsx, pdf, etc.), audio(.mp3, .wav) and video(.mp4, .mov)files.
